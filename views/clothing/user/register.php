<?php require_once ROOT . '/views/clothing/header.php'; ?>
    ...
    <div class="account-area ptb-80">
        <div class="container">
            <div class="row">
                <div class="col-sm-offset-3 col-sm-6 col-xs-12 lr2">
                    <?php if($result): ?>
                        ...
                        <form action="#" method="POST">
                            <div class="login-reg">
                                ...
                                <div class="input-box mb-20">
                                    ...
                                    <input type="email" class="info" placeholder="E-Mail" value="<?=@$_POST['email'];?>" name="email" required>
                                </div>
                                <div class="input-box">
                                    <label class="control-label">Password</label>
                                    <input type="password" class="info" placeholder="Password" value="<?=@$_POST['password'];?>" name="password" required>
                                </div>
                            </div>
