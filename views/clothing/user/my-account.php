                                ...
                                <div role="tabpanel" class="tab-pane fade in active" id="creativity">
                                    ...
                                    <form action="#" method="POST">
                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="input-box mb-20">
                                                ...
                                                <input type="text" name="name" class="info" placeholder="First Name" value="<?=@$name; ?>">
                                            </div>
                                       </div>
                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-box mb-20">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-box mb-20">
                                            ...
                                            <input type="email" name="email" class="info" placeholder="Your Email" value="<?=@$email; ?>">
                                        </div>
                                        </div>
                                         <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-box mb-20">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-box mb-20">
                                            ...
                                            <input type="password" name="password" class="info" placeholder="Password">
                                        </div>
                                        </div>
                                         <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-box mb-20">
                                   ...
                                   <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-offset-3 col-md-3 col-sm-4 col-xs-12 text-right">
