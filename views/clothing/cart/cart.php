                                                   ...
                                                   <div class="table-responsive mb-20">
                                                    <table class="shop_table-2 cart table">
                                                        ...
                                                        <?php if($productInCart): ?>
                                                            ...
                                                            <tr class="cart_item">
                                                                <td class="item-img">
                                                                    <a href="#"><img src="/views/clothing/images/product/<?=$product['image'];?>" alt=""> </a>
                                                                </td>
                                                                        ...
                                                                        <div class="product-qty">
                                                                            <div class="cart-quantity">
                                                                                <div class="cart-plus-minus">
                                                                                    ...
                                                                                    <input value="<?= $productInCart[$product['id']]; ?>" data-id="<?=$product['id']?>" name="qtybutton" class="cart-plus-minus-box" type="text">
                                                                ...
                                                                <td class="remove-item"><a href="/cart/delete/<?=$product['id'];?>"><i class="fa fa-trash-o"></i></a></td>
                                                            </tr>
                                                            <?php endforeach; ?>
                                                        <?php endif; ?>
                                                    ...
                                                    <div class="coupne-customer-area mb50">
                                                      ...
                                                      <div class="panel panel-checkout">
                                                        <div class="panel-heading" role="tab" id="headingTwo">
                                                          ...
                                                          <img src="views/clothing/images/icons/acc.jpg" alt="">
                                                           Returning customer?
