                ...
                <div class="row">
                   ...
                   <div class="about-us-wrap">
                       <div class="col-md-6 col-sm-12 col-xs-12">
                           <div class="about-img"><img src="views/clothing/images/blog/about.jpg" alt=""></div>
                       </div>
                       <div class="col-md-6 col-sm-12 col-xs-12">
                           <div class="about-des">
        ...
        <div class="better-area pb-70">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="skill-img"><img src="views/clothing/images/blog/skill.jpg" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="total-team team-carasoul">   
                            ...
                            <div class="single-product single-member">
                                <div class="product-img">
                                    <div class="single-prodcut-img  product-overlay pos-rltv">
                                        <a href="#"> <img alt="" src="views/clothing/images/team/01.jpg"></a>
                                    </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="single-product single-member">
                                <div class="product-img">
                                    <div class="single-prodcut-img  product-overlay pos-rltv">
                                        <a href="#"> <img alt="" src="views/clothing/images/team/02.jpg"></a>
                                    </div>
                                    <div class="product-icon socile-icon-tooltip text-center">
                                        <ul>
                                            <li><a href="#" data-tooltip="Facebook" class="add-cart" data-placement="left"><i class="zmdi zmdi-facebook"></i></a></li>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="single-product single-member">
                                <div class="product-img">
                                    <div class="single-prodcut-img  product-overlay pos-rltv">
                                        <a href="#"> <img alt="" src="views/clothing/images/team/03.jpg"></a>
                                    </div>
                                    <div class="product-icon socile-icon-tooltip text-center">
                                        <ul>
                                            <li><a href="#" data-tooltip="Facebook" class="add-cart" data-placement="left"><i class="zmdi zmdi-facebook"></i></a></li>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="single-product single-member">
                                <div class="product-img">
                                    <div class="single-prodcut-img  product-overlay pos-rltv">
                                        <a href="#"> <img alt="" src="views/clothing/images/team/04.jpg"></a>
                                    </div>
                                    <div class="product-icon socile-icon-tooltip text-center">
                                        <ul>
                                            <li><a href="#" data-tooltip="Facebook" class="add-cart" data-placement="left"><i class="zmdi zmdi-facebook"></i></a></li>
