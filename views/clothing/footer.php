        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 hidden-sm col-xs-12">
                <div class="single-footer instagrm-area">
                    ...
                    <div class="instagrm">
                        <ul>
                            <li><a href=""><img src="/views/clothing/images/gallery/01.jpg" alt=""></a></li>
                            <li><a href=""><img src="/views/clothing/images/gallery/02.jpg" alt=""></a></li>
                            <li><a href=""><img src="/views/clothing/images/gallery/03.jpg" alt=""></a></li>
                            <li><a href=""><img src="/views/clothing/images/gallery/04.jpg" alt=""></a></li>
                            <li><a href=""><img src="/views/clothing/images/gallery/05.jpg" alt=""></a></li>
                            <li><a href=""><img src="/views/clothing/images/gallery/06.jpg" alt=""></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="modal-product">
                                ...
                                <div class="tab-content active-portfolio-area-2">
                                    <div role="tabpanel" class="tab-pane active" id="view1">
                                        <div class="product-img">
                                            <a href=""><img src="/views/clothing/images/product/01.jpg" alt="Single portfolio" /></a>
                                        </div>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="view2">
                                        <div class="product-img">
                                            <a href=""><img src="/views/clothing/images/product/02.jpg" alt="Single portfolio" /></a>
                                        </div>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="view3">
                                        <div class="product-img">
                                            <a href=""><img src="/views/clothing/images/product/03.jpg" alt="Single portfolio" /></a>
                                        </div>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="view4">
                                        <div class="product-img">
                                            <a href=""><img src="/views/clothing/images/product/04.jpg" alt="Single portfolio" /></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="product-info">
                            ...
                            </div> <a href="/shop/shop.php" class="see-all">See all features</a>
