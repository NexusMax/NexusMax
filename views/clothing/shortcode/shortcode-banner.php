                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="banner-area-left ">
                               <div class="banner-single pos-rltv fix mb-30">
                                    <div class="banner-img"> 
                                        <img src="views/clothing/images/product/banner-01.jpg" alt="">
                                    </div>
                               ...
                               <div class="banner-single pos-rltv fix">
                                    <div class="banner-img left-type"> 
                                        <img src="views/clothing/images/product/banner-02.jpg" alt="">
                                    </div>
                        ...
                        <div class="col-md-4 hidden-sm col-xs-12">
                            <div class="banner-img-2 pos-rltv"> <img src="views/clothing/images/product/banner-03.jpg" alt="">
